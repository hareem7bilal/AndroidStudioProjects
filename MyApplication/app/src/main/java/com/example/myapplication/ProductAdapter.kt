...
class ProductAdapter(private val items: List<Product>, private val onItemClick: (Product) -> Unit): RecyclerView.Adapter<ProductAdapter.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        with(holder.binding){
            ...
            sizeText.text=sizeText.context.resources.getString(R.string.product_size_label, product.size)
